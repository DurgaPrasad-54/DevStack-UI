...
const HackathonNotifications = () => {
  ...
  if (loading) return <div className="student-notification-loading">Loading...</div>;
    ...
    <div className="student-notification-page">
      ...
      <div className="student-notification-container">
        ...
        <div className="student-notification-content">
          <h1 className="student-notification-title">Notifications</h1>
          <div className="student-notification-wrapper">
            {notifications.length === 0 ? (
              <div className="student-notification-no-container">
                <p className="student-notification-no-text">No notifications yet</p>
              </div>
            ) : (
                ...
                >
                  <div className="student-notification-avatar">
                    <img
                      ...
                      alt="notification"
                      className="student-notification-avatar-image"
                    />
                  </div>
                  <div className="student-notification-details">
                    <h3 className="student-notification-heading">{notification.title}</h3>
                    <p className="student-notification-description">{notification.description}</p>
                  ...
                  {!notification.read && (
                    <div className="student-notification-unread-dot"></div>
                  )}
                </div>
              ))
            )}
